 ...
 */
template <typename PropertyHolder>
void ComponentConverter::determinePropertyType(const PropertyHolder& propertyHolder, const PropertyPtr& property, Json::Value& parentJsonValue)
{
 ...
 */
template<typename PropertyHolderType, typename DataType>
void ComponentConverter::appendSimpleProperty(const PropertyHolderType& propertyHolder, const std::string& propertyName, Json::Value& parentJsonValue) {
 ...
 */
template<typename PropertyHolderType>
void ComponentConverter::appendListProperty(const PropertyHolderType& propertyHolder, const PropertyPtr& property, Json::Value& parentJsonValue)
{
    std::string propertyName = property.getName();
 ...
 */
template<typename PropertyHolderType>
void ComponentConverter::appendDictProperty(const PropertyHolderType& propertyHolder, const PropertyPtr& property, Json::Value& parentJsonValue)
{
    std::string propertyName = property.getName();
 ...
 */
template<typename PropertyHolderType>
void ComponentConverter::appendRatioProperty(const PropertyHolderType& propertyHolder, const std::string& propertyName, Json::Value& parentJsonValue)
{
 ...
 */
template<typename PropertyHolderType>
void ComponentConverter::appendComplexNumber(const PropertyHolderType& propertyHolder, const std::string& propertyName, Json::Value& parentJsonValue)
{
 ...
 */
template<typename PropertyHolderType>
void ComponentConverter::appendStructProperty(const PropertyHolderType& propertyHolder, const PropertyPtr& property, Json::Value& parentJsonValue)
{
    std::string propertyName = property.getName();
 ...
 */
template<typename PropertyHolderType>
void ComponentConverter::appendObjectProperty(const PropertyHolderType& propertyHolder, const PropertyPtr& property, Json::Value& parentJsonValue)
{
    std::string propertyName = property.getName();
    PropertyObjectPtr propertyObject = propertyHolder.getPropertyValue(propertyName);
    std::string propertyObjectName = property.getName();
